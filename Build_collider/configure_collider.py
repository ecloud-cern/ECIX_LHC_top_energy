...
# ==================================================================================================
def read_configuration(config_path="first_config.yaml"):
...
def configure_collider(
    ...
    collider_before_bb.to_json("collider_nobb.json")
...
# ==================================================================================================
def configure_and_track(config_path="first_config.yaml"):
    # Get configuration
    ...
    collider, config_sim, config_bb, collider_before_bb = configure_collider(
        config,
        config_mad,
        context,
...
if __name__ == "__main__":
    collider, config_sim, config_bb = configure_and_track()