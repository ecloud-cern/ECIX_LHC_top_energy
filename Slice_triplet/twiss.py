...
# collider_folder = '../Colliders/run3_collisions_30cm_160urad_1.2e11_2.0um_62.310_60.320_15_430_0.001/'
# collider_folder = '../Build_collider_run3/collider/'
collider_folder = '../Build_collider_run3/'
# collider = xt.Multiline.from_json(collider_folder + "collider.json")
collider = xt.Multiline.from_json(collider_folder + "collider_before_bb.json")
